          ...
          <div className="modal_wrapper text-gray-700 p-4" ref={wrapper}>
            ...
            <div className="w-3/4">
              ...
              <input
                ...
                className="w-full my-4 flex rounded-2xl p-2 border-2 border-slate-100 bg-bkg text-slate-100"
              />
              ...
              />
              <h1>Status</h1>
              <select className="w-full my-4 flex rounded-2xl p-2 border-2 border-slate-100 bg-bkg text-slate-100">
                <option value="incomplete">Incomplete</option>
                <option value="complete">Complete</option>
              </select>

              <h1>Tags</h1>
              <ul className="w-full my-4 flex justify-between rounded-2xl px-4 py-2 border-2 border-slate-100 bg-bkg text-slate-100">
